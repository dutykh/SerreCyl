...
This manuscript is organized as follows. First, in \cref{sec:model}, we describe the parent-level mathematical model along with the physical assumptions on which it is based. Finally, Appendix~\ref{sec:windkessel} presents a Windkessel model for pulsatile flow in viscoelastic vessels based on Serre-type approximations.
